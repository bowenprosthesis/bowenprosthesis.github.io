...
### *1. Design of an EHA-Driven Powered Ankle-Foot Prosthesis*  
  ...
  - [**Gen-1**](https://raw.githubusercontent.com/bowenprosthesis/bowenprosthesis.github.io/main/images/500x300.png): Off-board, damping-based hydraulic system  
  - **Gen-2**: Fully active, on-board direct-drive design  
  - [**Gen-3**](https://raw.githubusercontent.com/bowenprosthesis/bowenprosthesis.github.io/main/assets/prosthesis_design.pdf): Fully active prosthesis with hydraulic-based *Serial Elastic Actuation (SEA)*
